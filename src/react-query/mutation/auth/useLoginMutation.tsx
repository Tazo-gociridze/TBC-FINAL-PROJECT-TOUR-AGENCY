...
interface UseLoginMutationArgs {
    mutationOptions?: Omit<UseMutationOptions<LoginSuccessResponse, LoginErrorResponse, LoginCredentials>, 'mutationKey'>
}
const useLoginMutation = ({ mutationOptions = {} }: UseLoginMutationArgs): UseMutationResult<LoginSuccessResponse, LoginErrorResponse, LoginCredentials> => {
